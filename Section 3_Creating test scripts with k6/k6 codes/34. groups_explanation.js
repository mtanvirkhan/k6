...
export const options = {
    thresholds: {
        ...
        'group_duration{group:::Main page}': ['p(95)<11000'],
        'group_duration{group:::Main page::Assets}': ['p(95)<5000'],
        'group_duration{group:::Main page::Assets::Asset}': ['p(95)<3000'],
        'group_duration{group:::Main page::Assets::Asset::Asset}': ['p(95)<2000'],
