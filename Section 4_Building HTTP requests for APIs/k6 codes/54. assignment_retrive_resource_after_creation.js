...
export default function() {
    group("Simple authentication testing", function(){
        ...
        const res3 = http.get(`https://test-api.k6.io/my/crocodiles/${newCrocodileId}/`, params2);
        ...
        check(res3, {
            ...
            "corcodile name is Shit_head_big": (r) => r.json().name === 'Shit_head_big',
            "crocodile sex is F": (r) => r.json().sex === 'F'
        })
